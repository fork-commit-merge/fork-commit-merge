...
-   For React.js related issues, you need to install [Node.js and NPM](#installing-react).
...
[React.js - Easy](https://github.com/nikohoffren/fork-commit-merge/issues/533)
