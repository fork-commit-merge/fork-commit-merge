...
function displayProducts(products) {
    ...
    products.forEach(function (product) {
        ...
        ratingEl.textContent = "".concat(product.rating);
        productEl.appendChild(titleEl);
        productEl.appendChild(priceEl);
        productEl.appendChild(ratingEl);
        productBody === null || productBody === void 0 ? void 0 : productBody.appendChild(productEl);
    });
}
function applyFilters() {
    ...
    function (product) {
        var filteredProductsByPrice = (isNaN(minPrice) || product.price >= minPrice) &&
            (isNaN(maxPrice) || product.price <= maxPrice);
        var filteredProductsByRating = (isNaN(minRating) || product.rating >= minRating) &&
